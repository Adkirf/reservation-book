...
export default function WeekMonthYear() {
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    {visibleColumns.type && <TableHead className="hidden sm:table-cell">Type</TableHead>}
                    {visibleColumns.status && <TableHead className="hidden sm:table-cell">Status</TableHead>}
